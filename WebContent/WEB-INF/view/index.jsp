	...
	<section class="banners">
		<div class="top-banners">
			<div class="banner">
				<%
					if(nuovaUscita != null) {
				%>
					<a href="<%= request.getContextPath() %>/Catalogo?ordinamento=NUOVE_USCITE">
		...
		<div class="bottom-banners">
			<div class="banner">
				...
				%>
					<a href="<%= request.getContextPath() %>/Catalogo?ordinamento=MIGLIORI_OFFERTE">
			...
			<div class="banner">
				<%
					if(piuVenduto != null) {
				%>
					<a href="<%= request.getContextPath() %>/Catalogo?ordinamento=PIU_VENDUTI">
